...
const SkillShikshyaJourney = () => {
    return (
        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="rounded-3xl p-8 text-white relative overflow-hidden min-h-[300px] bg-[#F45B5B]">
                <div className="flex items-center justify-between h-full">
                    <div className="flex items-center justify-center">
                        <img src="/public/images/Group.png" alt="pfp-1" className="max-h-32 w-auto object-contain"/>
                    </div>
            ...
            <div className="rounded-3xl p-8 text-white relative overflow-hidden min-h-[300px]  bg-[#5492A0]">
                <div className="flex items-center justify-between h-full">
                    ...
                    <div className="flex items-center justify-center">
                        <img src="/public/images/Group (1).png" alt="" className="max-h-32 w-auto object-contain"/>
                    </div>
                </div>
            </div>
